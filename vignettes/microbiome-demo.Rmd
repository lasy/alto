...
plot_alignment(aligned_topics, color_by = "re")
...
plot_alignment(aligned_topics, color_by = "ro")
...
plot_beta_lsy(aligned_topics, models = c("k3","k6","k12", "k20"), min_beta = 0.005, color_by  = "branch")

plot_beta_lsy(aligned_topics, models = c("k3","k6","k12", "k20"), min_beta = 0.005, color_by  = "robustness")
