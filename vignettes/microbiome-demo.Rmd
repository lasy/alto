...
```{r beta-plot}
plot_beta(aligned_topics_product, models = c("k3", "k7","k12","k18"), min_beta = 0.005)
plot_beta(aligned_topics_transport, models = c("k3", "k7","k12","k18"), min_beta = 0.005)
```
...
make_figure <- function(aligned_topics_product,
  ...
  g_beta_transport =  plot_beta(aligned_topics_transport, models = c("k3", "k7","k12",last(aligned_topics_transport@topics$m %>% levels())), min_beta = 0.003)
