...
for (k in 1:12) {lda_varying_params_lists[[paste0("k",k)]] = list(k = k)}
...
plot_alignment(aligned_topics_lsy, color_by = "b")
...
plot_alignment(aligned_topics_lsy, color_by = "r")

plot_alignment(aligned_topics_lsy, color_by = "s")
